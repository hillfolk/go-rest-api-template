...
go build -ldflags "-X github.com/hillfolk/go-rest-api-template/main.Version=`git describe --tags` -X github.com/hillfolk/go-rest-api-template/main.Commit=`git rev-parse --short HEAD`" -o bin/go-rest-api-template
